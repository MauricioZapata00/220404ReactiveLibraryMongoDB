...
@ContextConfiguration(classes = {ObtainBooksRouter.class, UseCaseObtainBooks.class,
        ObtainByIdRouter.class, UseCaseObtainById.class,
        AddBookRouter.class, UseCaseAddBook.class,
        ModifyBookRouter.class, UseCaseModifyBook.class,
        EraseBookRouter.class, UseCaseEraseBook.class,
        BookAvailabilityRouter.class, UseCaseBookAvailability.class,
        ReturnBookRouter.class, UseCaseReturnBook.class,
        BorrowBookRouter.class, UseCaseBorrowBook.class,
        RecommendedBookRouter.class, UseCaseRecommendedBooks.class,
        BookMapper.class})
...
class BookRouterTest {
    ...
    void obtenerPorId() {
        ...
        DTO DTO = new DTO(dato1.getId(),dato1.getTitulo(),dato1.getClasificacion(), dato1.getArea(), dato1.isPrestado());
        Mono<Book> recursoMono = Mono.just(dato1);
