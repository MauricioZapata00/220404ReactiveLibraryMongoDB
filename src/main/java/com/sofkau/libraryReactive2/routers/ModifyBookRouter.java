...
import com.sofkau.libraryReactive2.usecase.UseCaseModifyBook;
...
@Configuration
public class ModifyBookRouter {
    @Bean
    public RouterFunction<ServerResponse> modificarUnRecursoDeLibro(UseCaseModifyBook useCaseModifyBook) {
